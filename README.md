...
If you're looking for a starter development task to get your feet wet with our codebase, any of our Issues tagged [help wanted](https://github.com/opensacorg/opensac.org/issues) might be a good fit.
...
- [Next.js](https://nextjs.org/), a full-stack framework for JavaScript
...
```shell
git clone https://github.com/opensacorg/opensac.org.git
```
...
- [Open Websites Figma](https://www.figma.com/design/attWQWKwed1XSaaaMuzM5m/Open-Websites?m=auto&t=uUzjBVYxhFLshnBN-1).
